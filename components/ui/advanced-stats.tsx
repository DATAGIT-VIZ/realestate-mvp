...
const kpis = [
  { label: 'Total Revenue',         value: '₹2.4 Cr', change: '+12.5%', status: 'up' },
  { label: 'Active Leads',          value: '14,205',  change: '+4.2%',  status: 'up' },
  { label: 'Avg. Response Time',    value: '3.2 min', change: '-8.1%',  status: 'down' },
  { label: 'Conversion Rate',       value: '18.4%',   change: '+0.6%',  status: 'up' },
]
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div>
                ...
                <h4 className="text-xl font-bold tracking-tight">Team Pipeline</h4>
              </div>
              <div className="mt-8">
                <div className="flex justify-between items-end mb-2">
                  <span className="text-3xl font-semibold tracking-tighter">82%</span>
                  <span className="text-xs font-medium text-zinc-400 mb-1">Target: ₹10 Cr</span>
                </div>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="size-8 rounded-lg bg-white flex items-center justify-center border border-zinc-100">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5" fill="none" stroke="#141B34" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <h4 className="font-bold text-zinc-900">Lead Growth</h4>
              </div>
              <p className="text-sm text-zinc-500">
                Organic portal inflow is up{' '}
            ...
            >
              ...
              <div className="flex items-baseline justify-between">
                ...
                <span className={cn(
                  ...
                  kpi.status === 'up' ? 'text-emerald-600 bg-emerald-50' : 'text-rose-600 bg-rose-50'
                )}>
                  {kpi.change}
                </span>
              </div>
