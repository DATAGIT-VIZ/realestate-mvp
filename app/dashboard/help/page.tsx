...
const FAQS = [
  {
    ...
    items: [
      {
        q: 'What is a CS ID?',
        a: 'CS ID (Customer System ID) is a unique identifier assigned to every lead the moment they enter Lead Gap CRM — whether added manually, imported via CSV, or auto-captured from portals like MagicBricks or 99acres. Format: CS00001, CS00042, etc. Use it to search for a lead instantly across any screen.',
      },
      {
      ...
      <div style={{ background: 'linear-gradient(135deg,#4c00b0,#a000c8)', padding: '32px 28px 28px' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.7)', margin: '0 0 20px', lineHeight: 1.6 }}>
            Everything you need to get the most out of Lead Gap CRM CRM.
          </p>
          {/* Search */}
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '24px 28px 60px' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg,rgba(160,0,200,0.05),rgba(160,0,200,0.04))', border: `1px solid rgba(160,0,200,0.15)`, borderRadius: 16, padding: '20px 22px' }}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            <a href="mailto:support@leadgap.in"
