...
I am using Lead Gap CRM CRM to manage my property enquiries. I'd like to enable automatic lead forwarding from ${portal.name} to my CRM.
...
`Hi, I'm using Lead Gap CRM CRM and would like to enable automatic lead forwarding from ${portal.name}.
