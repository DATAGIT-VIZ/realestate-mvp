    ...
    <div style={{ padding: '28px 28px 60px', minHeight: '100vh', background: C.bg }}>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 13, color: C.muted, margin: '0 0 0 52px', lineHeight: 1.6 }}>
          Connect Lead Gap CRM with your portals. Leads flow in automatically — no manual copy-paste.
        </p>
      </div>
      ...
      <div style={{ marginTop: 28, background: C.panel, border: `1px solid ${C.border}`, borderRadius: 16, padding: '16px 20px', display: 'flex', gap: 12, alignItems: 'flex-start' }}>
        ...
        <div style={{ fontSize: 13, color: C.muted, lineHeight: 1.6 }}>
          <strong style={{ color: C.text }}>How it works:</strong> Each integration gives you a unique webhook URL. Send it to your portal's account manager — they configure it on their end. Once done, every new enquiry lands directly in Lead Gap CRM, auto-scored and ready to call.
        </div>
      </div>
