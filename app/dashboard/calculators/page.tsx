    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-600 rounded-lg pl-8 pr-4 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
              </div>
              <p className="text-xs text-slate-500 mt-1">Total property price</p>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2.5 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
              />
            </div>
          </div>
        </div>
          ...
          <div className="space-y-5">
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm text-emerald-400">{downPaymentPercent}%</span>
              </div>
              <input
                type="range"
                min="10"
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm text-emerald-400">{loanTenure} years</span>
              </div>
              <input
                type="range"
                min="5"
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm text-emerald-400">{interestRate}%</span>
              </div>
              <input
                type="range"
                min="6"
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-slate-400">Registration & Stamp Duty</label>
                <span className="text-sm text-emerald-400">{stampDutyPercent}%</span>
              </div>
              <input
                type="range"
                min="5"
                ...
                className="w-full accent-emerald-500"
              />
              <p className="text-xs text-slate-500 mt-1">{formatCurrency(calculations.stampDuty)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-slate-400 mb-2">Expected Monthly Rent</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">₹</span>
                <input
                  type="number"
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-slate-400">Annual Rent Increase</label>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-slate-400 mb-2">Monthly Maintenance</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">₹</span>
                <input
                  type="number"
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-slate-400">Annual Property Tax</label>
              ...
              />
              <p className="text-xs text-slate-500 mt-1">{formatCurrency(propertyPrice * annualPropertyTaxPercent / 100)}/year</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          ...
          <div className="space-y-5">
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-slate-400">Property Appreciation</label>
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-slate-400">Alternative Investment Return</label>
      ...
      <div className="lg:col-span-3 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/10 rounded-xl p-5 border border-emerald-500/30">
            <p className="text-slate-400 text-sm mb-1">Total Cost to Buy</p>
            <p className="text-2xl font-bold text-white">{formatCurrency(calculations.totalBuyCost)}</p>
            <p className="text-xs text-slate-500 mt-2">Over {timeHorizon} years</p>
          </div>

          <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/10 rounded-xl p-5 border border-cyan-500/30">
            <p className="text-slate-400 text-sm mb-1">Total Cost to Rent</p>
            <p className="text-2xl font-bold text-white">{formatCurrency(calculations.totalRentCost)}</p>
            <p className="text-xs text-slate-500 mt-2">Over {timeHorizon} years</p>
          </div>

          <div className={`rounded-xl p-5 border ${calculations.isBuyingBetter
            ...
            <p className="text-slate-400 text-sm mb-1">Net Gain/Loss</p>
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/10 rounded-xl p-5 border border-purple-500/30">
            <p className="text-slate-400 text-sm mb-1">Break-even Point</p>
            <p className="text-2xl font-bold text-white">
              {calculations.breakEvenYear ? `Year ${calculations.breakEvenYear}` : `>${timeHorizon} years`}
            </p>
            <p className="text-xs text-slate-500 mt-2">When buying becomes profitable</p>
          </div>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-emerald-400">₹{formatNumber(calculations.emi)}</p>
            </div>
            <div className="text-right">
              <p className="text-slate-400 text-sm">vs Monthly Rent</p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {calculations.yearlyData.filter((_, i) => i % 2 === 0 || i === calculations.yearlyData.length - 1).map((data) => (
                  <tr key={data.year} className="border-b border-slate-700/50 hover:bg-slate-700/30">
                    <td className="py-2 px-2 text-white font-medium">{data.year}</td>
                    ...
                    <td className="text-right py-2 px-2 text-emerald-400">{formatCurrency(data.propertyValue)}</td>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          ...
          <div className="space-y-5">
            <div>
              <label className="block text-sm text-slate-400 mb-2">Loan Amount</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">₹</span>
                <input
                  type="number"
              ...
              <p className="text-xs text-slate-500 mt-1">{formatCurrency(loanAmount)}</p>
            </div>
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-slate-400">Loan Tenure</label>
                <span className="text-sm text-emerald-400">{tenure} years</span>
              </div>
              <input
                type="range"
                min="5"
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            />
            <span className="text-white font-medium">Add Annual Prepayment</span>
          </label>

          {enablePrepayment && (
            <div className="mt-4">
              <label className="block text-sm text-slate-400 mb-2">Annual Prepayment Amount</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">₹</span>
                <input
                  type="number"
        ...
        <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/10 rounded-xl p-6 border border-emerald-500/30">
          <p className="text-slate-400 text-sm mb-2">Your Monthly EMI</p>
          ...
          <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-slate-700">
            <div>
              ...
              <p className="text-white font-semibold">{formatCurrency(calculations.totalPayment)}</p>
            </div>
            <div>
              <p className="text-slate-500 text-xs">Interest : Principal</p>
        ...
        {enablePrepayment && calculations.prepaymentSavings > 0 && (
          <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/10 rounded-xl p-5 border border-green-500/30">
            ...
            <div className="space-y-2">
              ...
              <p className="text-green-400">
                ⏱️ Reduce tenure by <strong>{calculations.prepaymentTenureReduction.toFixed(1)} years</strong>
              </p>
            </div>
          </div>
        )}
      ...
      <div className="lg:col-span-3 space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 text-center">
            <p className="text-slate-400 text-xs mb-1">Principal Amount</p>
            <p className="text-xl font-bold text-emerald-400">{formatCurrency(loanAmount)}</p>
          ...
          <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700 text-center">
            ...
            <p className="text-xl font-bold text-white">{formatCurrency(calculations.totalPayment)}</p>
            <p className="text-xs text-slate-500 mt-2">Over {tenure} years</p>
          </div>
        </div>
            ...
            <div className="relative w-48 h-48">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <p className="text-2xl font-bold text-white">{Math.round(loanAmount / calculations.totalPayment * 100)}%</p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">{formatCurrency(loanAmount)}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">{formatCurrency(calculations.totalInterest)}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">Loan Balance Over Time</h3>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">📊 Tenure Comparison</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-slate-400 border-b border-slate-700">
              ...
              <tbody>
                {calculations.tenureComparison.map((row) => (
                  <tr
                    key={row.tenure}
                    className={`border-b border-slate-700/50 ${row.tenure === tenure ? 'bg-emerald-500/10' : 'hover:bg-slate-700/30'}`}
                  >
                    <td className="py-2 px-3 text-white font-medium">
                      {row.tenure} years
                      {row.tenure === tenure && <span className="ml-2 text-xs text-emerald-400">(Selected)</span>}
                    </td>
                    ...
                    <td className="text-right py-2 px-3 text-white">{formatCurrency(row.totalCost)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="bg-slate-800/50 rounded-xl border border-slate-700 overflow-hidden">
          <button
            ...
            className="w-full p-5 flex items-center justify-between text-white hover:bg-slate-700/30 transition-colors"
          >
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {calculations.monthlyData.slice(0, 60).map((row) => (
                    <tr key={row.month} className="border-b border-slate-700/30 hover:bg-slate-700/20">
                      <td className="py-2 px-3 text-white">{row.month}</td>
                      <td className="text-right py-2 px-3 text-slate-300">₹{formatNumber(row.emi)}</td>
                      <td className="text-right py-2 px-3 text-emerald-400">₹{formatNumber(row.principal)}</td>
...
function RentalYieldCalculator({ onInputChange }: { onInputChange?: (inputs: Record<string, any>) => void }) {
  ...
  const calculations = useMemo(() => {
    ...
    if (netYield >= 6) {
      ...
      investmentDecision = { verdict: 'Marginal', color: 'amber', icon: '⚠️', message: 'Marginal returns - consider negotiating price' }
    } else {
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-slate-400">Occupancy Rate</label>
                <span className="text-sm text-emerald-400">{occupancyRate}%</span>
              </div>
              <input
                type="range"
                min="70"
                ...
                className="w-full accent-emerald-500"
              />
              <p className="text-xs text-slate-500 mt-1">Assume some vacancy periods</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-2">Annual Property Tax</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">₹</span>
                <input
                  type="number"
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-2">Annual Insurance</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">₹</span>
                <input
                  type="number"
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-slate-400">Management Fees</label>
              ...
              <input
                ...
                className="w-full accent-amber-500"
              />
              <p className="text-xs text-slate-500 mt-1">Of effective rent</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <label className="flex items-center gap-3 cursor-pointer mb-4">
            <input
              ...
              className="w-5 h-5 rounded border-slate-600 bg-slate-900 text-emerald-500 focus:ring-emerald-500"
            />
            <span className="text-white font-medium">Include Financing</span>
          </label>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          ...
          <div className="space-y-5">
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-slate-400">Rent Increase Rate</label>
      ...
      <div className="lg:col-span-3 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/10 rounded-xl p-5 border border-emerald-500/30">
            ...
            <p className="text-3xl font-bold text-emerald-400">{calculations.grossYield.toFixed(2)}%</p>
            <p className="text-xs text-slate-500 mt-2">
              {calculations.grossYield >= 4 ? '✅ Good: >4%' : '⚠️ Below 4%'}
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/10 rounded-xl p-5 border border-amber-500/30">
            ...
            <p className="text-xs text-slate-500 mt-2">Including appreciation</p>
          </div>
        </div>

        {/* Investment Decision */}
        <div className={`rounded-xl p-5 border ${calculations.investmentDecision.color === 'green' ? 'bg-green-500/10 border-green-500/30' :
          calculations.investmentDecision.color === 'emerald' ? 'bg-emerald-500/10 border-emerald-500/30' :
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className={`font-semibold text-lg ${calculations.investmentDecision.color === 'green' ? 'text-green-400' :
                calculations.investmentDecision.color === 'emerald' ? 'text-emerald-400' :
                  calculations.investmentDecision.color === 'amber' ? 'text-amber-400' :
                    'text-red-400'
                }`}>
                {calculations.investmentDecision.verdict} Investment
              </p>
              <p className="text-slate-400 text-sm">{calculations.investmentDecision.message}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">💵 Annual Cash Flow Breakdown</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-emerald-500/10 rounded-lg">
              <span className="text-slate-300">+ Rental Income (after vacancy)</span>
              <span className="text-emerald-400 font-semibold">+{formatCurrency(calculations.effectiveRent)}</span>
            </div>
            {useFinancing && (
              <div className="flex justify-between items-center p-3 bg-red-500/10 rounded-lg">
                <span className="text-slate-300">- Loan EMI</span>
            ...
            <div className="flex justify-between items-center p-3 bg-amber-500/10 rounded-lg">
              <span className="text-slate-300">- Taxes & Insurance</span>
              <span className="text-amber-400 font-semibold">-{formatCurrency(annualPropertyTax + annualInsurance)}</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-amber-500/10 rounded-lg">
              <span className="text-slate-300">- Management Fees</span>
            ...
            <div className={`flex justify-between items-center p-3 rounded-lg border-2 ${calculations.annualCashFlow >= 0 ? 'bg-green-500/20 border-green-500/50' : 'bg-red-500/20 border-red-500/50'
              ...
              <span className="text-white font-semibold">= Net Annual Cash Flow</span>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">📈 Cash Flow Projection ({years} years)</h3>
          <div className="h-[250px]">
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart data={chartData}>
                <CartesianGrid strokeDasharray="3 3" stroke="#334155" />
        ...
        {/* Investment Comparison */}
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">⚖️ Compare to Other Investments</h3>
          <div className="space-y-3">
            {calculations.comparisons.map((item, index) => (
              <div key={index} className="flex items-center gap-4">
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
                    <span className={`text-sm ${item.name === 'This Property' ? 'text-white font-semibold' : 'text-slate-400'}`}>
                      {item.name}
                    </span>
                    <span className={`text-sm font-medium ${item.name === 'This Property' ? 'text-amber-400' : 'text-slate-300'}`}>
                      {item.rate.toFixed(1)}%
                    </span>
                  </div>
        ...
        {/* Final Summary */}
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">💰 After {years} Years</h3>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-slate-700/30 rounded-lg">
              <p className="text-slate-400 text-sm">Property Value</p>
              <p className="text-2xl font-bold text-emerald-400">{formatCurrency(calculations.finalValue)}</p>
            </div>
            <div className="p-4 bg-slate-700/30 rounded-lg">
              <p className="text-slate-400 text-sm">Capital Gain</p>
              <p className="text-2xl font-bold text-green-400">{formatCurrency(calculations.totalCapitalGain)}</p>
            </div>
            <div className="p-4 bg-slate-700/30 rounded-lg">
              <p className="text-slate-400 text-sm">Total Cash Flow</p>
              <p className={`text-2xl font-bold ${calculations.yearlyData[calculations.yearlyData.length - 1]?.cumulativeCashFlow >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-slate-400 mb-2">Initial Investment (Down Payment)</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">₹</span>
                <input
                  type="number"
            ...
            <div>
              <label className="block text-sm text-slate-400 mb-2">Current Market Value</label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">₹</span>
                <input
                  type="number"
              ...
              <p className="text-xs text-slate-500 mt-1">{formatCurrency(currentMarketValue)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <label className="flex items-center gap-3 cursor-pointer mb-4">
            <input
              ...
              className="w-5 h-5 rounded border-slate-600 bg-slate-900 text-emerald-500 focus:ring-emerald-500"
            />
            <span className="text-white font-medium">Include Home Loan</span>
          </label>
            ...
            <div className="space-y-4">
              ...
              {hasLoan && (
                <div className="p-3 bg-slate-700/30 rounded-lg">
                  ...
                  <p className="text-xl font-bold text-emerald-400">₹{formatNumber(calculations.monthlyEMI)}</p>
                </div>
              )}
            </div>
          )}
        ...
        {/* Scenario Toggle */}
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">📊 Appreciation Scenario</h3>
            ...
            {[
              ...
              <button
                ...
                className={`flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-all ${scenario === key
                  ? key === 'conservative' ? 'bg-slate-600 text-white' :
                    key === 'moderate' ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/50' :
      ...
      <div className="lg:col-span-3 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/10 rounded-xl p-5 border border-emerald-500/30">
            ...
            <p className="text-xs text-slate-500 mt-2">+{calculations.appreciationPercent.toFixed(1)}% growth</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/10 rounded-xl p-5 border border-cyan-500/30">
            ...
            <p className="text-xs text-slate-500 mt-2">By {currentYear + 5}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/10 rounded-xl p-5 border border-purple-500/30">
            ...
            <p className="text-xs text-slate-500 mt-2">Principal repaid</p>
          </div>

          <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/10 rounded-xl p-5 border border-amber-500/30">
            <p className="text-slate-400 text-sm mb-1">💰 Total Wealth Created</p>
            <p className="text-3xl font-bold text-amber-400">{formatCurrency(calculations.totalWealthCreated)}</p>
            <p className="text-xs text-slate-500 mt-2">Net worth increase</p>
          </div>
        </div>

        {/* LTV Gauge */}
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">📊 Loan-to-Value (LTV) Ratio</h3>
          <div className="flex items-center gap-8">
            ...
            <div className="flex-1">
              <div className="flex justify-between mb-2">
                <span className="text-slate-400 text-sm">LTV by {currentYear + 5}</span>
          ...
          <p className="text-xs text-slate-500 mt-3 text-center">
            {calculations.finalLTV <= 50 ? '✅ Healthy LTV - less than 50%' :
              calculations.finalLTV <= 75 ? '⚠️ Moderate LTV - consider prepayments' :
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">📅 5-Year Projection ({scenario.charAt(0).toUpperCase() + scenario.slice(1)})</h3>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-slate-400 border-b border-slate-700">
              ...
              <tbody>
                {calculations.mainProjection.map((row) => (
                  <tr key={row.year} className="border-b border-slate-700/50 hover:bg-slate-700/30">
                    <td className="py-2 px-2 text-white font-medium">{row.calendarYear}</td>
                    ...
                    <td className={`text-right py-2 px-2 ${row.yoyGrowth > 0 ? 'text-green-400' : 'text-slate-400'}`}>
        ...
        {/* Wealth Growth Chart */}
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">📈 Wealth Growth Over 5 Years</h3>
        ...
        <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700">
          <h3 className="text-white font-semibold mb-4">⚖️ Scenario Comparison</h3>
          <div className="h-[250px]">
            <ResponsiveContainer width="100%" height="100%">
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">ROI Calculators</h1>
            <p className="text-slate-400 text-sm">Make data-driven real estate decisions</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-white transition-colors"
          >
          ...
          <div className="relative bg-slate-900 border border-slate-700 rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-white">Share Calculator</h3>
                  <p className="text-xs text-slate-500">Create a shareable link for your client</p>
                </div>
              </div>
              <button
                onClick={() => setShowShareModal(false)}
            ...
            {!shareUrl ? (
              <>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    <label className="block text-sm text-slate-400 mb-2">Your Phone (for client to contact)</label>
                    <input
                      type="tel"
                      value={agentPhone}
                  ...
                  <div>
                    <label className="block text-sm text-slate-400 mb-2">Client Phone (optional, for WhatsApp)</label>
                    <input
                      type="tel"
                      value={clientPhone}
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-400 disabled:bg-slate-700 disabled:text-slate-500 text-white py-3 rounded-xl font-medium transition-colors disabled:cursor-not-allowed"
                >
                  {shareLoading ? (
                    <>
              ...
              <>
                ...
                <div className="text-center mb-6">
                  ...
                  <h4 className="text-xl font-semibold text-white mb-2">Link Generated!</h4>
                  <p className="text-slate-400 text-sm">Share this link with your client</p>
                </div>

                {/* URL Display */}
                <div className="bg-slate-800 rounded-lg p-3 mb-4">
                  <p className="text-emerald-400 text-sm break-all">{shareUrl}</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 py-3 rounded-xl font-medium transition-colors ${copied
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-medium transition-colors"
                  >
