  ...
  return (
    <div>
      <div style={{ fontSize: 12, color: MUTED, marginBottom: 16 }}>
        Connect your property portals to auto-import leads directly into Lead Gap CRM. Each portal sends leads via webhook — no manual copy-paste.
      </div>
...
function BrandingSection() {
  return (
    <div>
      <div style={{ marginBottom: 20 }}>
        <div style={{ fontSize: 12, color: MUTED, marginBottom: 14 }}>Your branding appears on printed reports and client-facing documents generated in Lead Gap CRM.</div>
