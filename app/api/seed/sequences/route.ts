    ...
    steps: [
      {
        ...
        message_body: `Hi {{name}}! Thank you for your interest in properties in {{city}}. I'm your dedicated advisor from Lead Gap CRM. Could you share your preferred configuration (2BHK/3BHK) and exact budget? I'll shortlist the best available options for you right away.`,
      },
      {
